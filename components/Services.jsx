...
export default function Services() {
  ...
  const services = [
    {
      name:
        language === "EN" ? "Fullstack Development" : "Pengembangan Fullstack",
      icon: SiJavascript,
      description:
        language === "EN"
    ...
    },
    {
      ...
      description:
        language === "EN"
          ? "Support organized teamwork through collaboration, version control, consistent development workflows, and Scrum & Agile methodologies."
          : "Mendukung proses kerja tim yang terorganisir melalui kolaborasi, manajemen versi, alur pengembangan yang konsisten, serta metodologi Scrum dan Agile",
    },
  ];
  return (
    <div id="services" className="w-full px-[12%] py-10 scroll-mt-20">
      <h4 className="text-center mb-2 text-lg font-Ovo">
        {language === "EN" ? "Core Expertise" : "Kemampuan Utama"}
      </h4>

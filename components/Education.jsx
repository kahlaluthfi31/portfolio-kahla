...
export default function Education() {
    ...
    return (
        <section id="education" className="w-full px-[12%] py-10 scroll-mt-20">
            <h4 className="text-center mb-2 text-lg font-Ovo">{language === "EN" ? "Education Journey" : "Riwayat Pendidikan"}</h4>
            <h2 className="text-center text-5xl font-Ovo mb-12">{language === "EN" ? "Education" : "Pendidikan"}</h2>
            ...
            <div className="max-w-5xl mx-auto p-6 sm:p-10">
                ...
                <div className="relative">
                    ...
                    {educationList.map((item) => (
                        <div key={item.institusi} className="relative mb-10 last:mb-0 pl-10 sm:pl-14">
                            ...
                            <h4 className="text-2xl font-semibold leading-tight text-gray-800 dark:text-white">{item.institusi}</h4>
                            <p className="text-gray-700 dark:text-white/85 text-xl mt-1">{language === "EN" ? (item.jurusanEn || item.jurusan) : item.jurusan}</p>
                            <p className="text-[#B923DF] text-xl sm:text-2xl font-medium mt-2 mb-1">{language === "EN" ? (item.periodEn || item.period) : item.period}</p>

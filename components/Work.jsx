...
export default function Work() {
  ...
  const work = [
    ...
    {
      name: "Invitela - Digital Invitation ",
      icon: "/assets/invitela.png",
      year: "Coming Soon",
      link: "",
      category: { ID: "APLIKASI WEB", EN: "WEB APP" },
      techStack: [
        "Next.js",
        "TypeScript",
        "TailwindCSS",
      ...
      summary: {
        ID: "Platform jasa undangan digital dengan katalog template interaktif, admin dashboard untuk kelola pesanan & konten, dan dapat mengirim ke semua tamu undangan (unlimited).",
        EN: "Digital invitation platform with interactive template catalog, admin dashboard for managing orders & content, and ability to send to unlimited wedding guests.",
      },
      size: "lg",
    },
  ];
